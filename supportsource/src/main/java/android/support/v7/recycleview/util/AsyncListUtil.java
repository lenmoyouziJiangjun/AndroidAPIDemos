...
import android.support.v7.recycleview.widget.RecyclerView;
...
public class AsyncListUtil<T> {
     ...
     *
     * @param kclass       Class of the data item.
     ...
     */
    public AsyncListUtil(Class<T> kclass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        mTClass = kclass;
        mTileSize = tileSize;
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() {
        ...
        private SparseBooleanArray mLoadedTiles = new SparseBooleanArray();
    ...
    public static abstract class ViewCallback {
         ...
         * storage).
         */
        public static final int HINT_SCROLL_ASC = 1;
