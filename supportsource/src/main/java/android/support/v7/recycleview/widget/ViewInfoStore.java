...
import android.support.v7.recycleview.map.ArrayMap;
import android.support.v7.recycleview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
import android.support.v7.recycleview.widget.RecyclerView.ViewHolder;

import java.util.Map;

import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_POST;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_PRE;
import static android.support.v7.recycleview.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;

/**
 * Version 1.0
 * Created by lll on 17/7/19.
 * Description This class abstracts all tracking for Views to run animations.
...
public class ViewInfoStore {
    ...
    private ItemHolderInfo popFromLayoutStep(ViewHolder viewHolder, int flag) {
        int index = mLayoutHolderMap.indexOfKey(viewHolder);
        if (index < 0) {
            return null;
        }
