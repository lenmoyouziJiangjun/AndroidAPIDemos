...
public interface SupportMenuItem extends MenuItem {
    ...
    */
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link MenuItemCompat.OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link MenuItemCompat.OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
    ...
    /**
     * Set an {@link MenuItemCompat.OnActionExpandListener} on this menu item to be notified when the associated
