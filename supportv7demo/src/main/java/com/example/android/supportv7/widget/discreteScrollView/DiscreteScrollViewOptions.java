...
public class DiscreteScrollViewOptions {
    ...
    public static void configureTransitionTime(DiscreteScrollView scrollView, final Context context) {
        ...
        defaultPrefs(context).registerOnSharedPreferenceChangeListener(timeChangeListener);
        bsd.setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
            public void onDismiss(DialogInterface dialog) {
                defaultPrefs(context).unregisterOnSharedPreferenceChangeListener(timeChangeListener);
            }
        });
