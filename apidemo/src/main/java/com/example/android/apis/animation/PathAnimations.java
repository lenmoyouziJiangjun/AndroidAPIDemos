...
public class PathAnimations extends Activity implements
    ...
    private void startAnimator(int checkedId) {
        ...
        if (checkedId == R.id.named_components) {
        ...
        } else if (checkedId == R.id.property_components) {
        ...
        } else if (checkedId == R.id.multi_int) {
        ...
        } else if (checkedId == R.id.multi_float) {
        ...
        } else if (checkedId == R.id.named_setter) {
        ...
        } else if (checkedId == R.id.property_setter) {
